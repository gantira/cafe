                    ...
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="form-group @error('foto') is-invalid @enderror">
                            ...
                            <div class="position-relative">
                                @if ($updatedPhoto)
                                    <img src="{{ $updatedPhoto->temporaryUrl() }}" class="w-200">
                                @elseif ($foto_preview)
                                    <img src="{{ $foto_preview }}" class="w-200">
                                @else
                            ...
                            <div class="custom-file mx-5">
                                <input wire:model="updatedPhoto" type="file" id="Foto Produk" accept=".jpg,.png,.jpeg">
